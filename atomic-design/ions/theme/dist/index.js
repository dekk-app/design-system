...
const dark = Object.assign(Object.assign({}, base), {
  ui: {
    ...
    background: {
      "1": colors.darkest.value,
      "2": colors.lightest.value
    },
    text: {
      "1": colors.darkText1.value,
      "2": colors.lightText1.value
    },
    outline: {
      "1": colors.darkOutline1.value
    },
    fill: {
      "1": colors.darkFill1.value,
      "2": colors.darkFill2.value,
      "3": colors.darkFill3.value,
      "4": colors.darkFill4.value
    }
  }
});
