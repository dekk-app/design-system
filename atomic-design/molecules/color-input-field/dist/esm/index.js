 ...
 */
import { StyledCombinedInput, StyledInput as StyledInput$1 } from '@dekk-ui/input-field/styled';
...
const ColorInput = /*#__PURE__*/forwardRef(({
  ...
  const handleKeyDown = useCallback(event_ => {
  ...
  return /*#__PURE__*/React.createElement(StyledCombinedInput, {
  ...
  }), /*#__PURE__*/React.createElement(StyledColorInput, {
    ref: ref,
    value: value,
    type: "color",
    onChange: handleChange
