...
const StyledToggleButton = _styled__default['default']("button", process.env.NODE_ENV === "production" ? {
  target: "ecytk870"
} : {
  target: "ecytk870",
...
const ToggleButton = _a => {
  ...
  return /*#__PURE__*/React__default['default'].createElement(StyledToggleButton, _extends({}, props, {
    className: className
  }), children);
};
