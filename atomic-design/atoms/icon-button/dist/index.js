...
var icons = require('@dekk-ui/icons');
...
const StyledSvg = _styled__default['default']("svg", process.env.NODE_ENV === "production" ? {
  target: "e17lkvz82"
} : {
  target: "e17lkvz82",
  label: "StyledSvg"
...
const StyledPath = _styled__default['default']("path", process.env.NODE_ENV === "production" ? {
  target: "e17lkvz81"
} : {
  target: "e17lkvz81",
  label: "StyledPath"
...
const IconButton = _a => {
  ...
  return /*#__PURE__*/React__default['default'].createElement(StyledButton, _extends({}, props, {
    "aria-label": icon
  }), /*#__PURE__*/React__default['default'].createElement(StyledSvg, {
    height: size,
    width: size,
    viewBox: `0 0 ${size} ${size}`
  }, /*#__PURE__*/React__default['default'].createElement(StyledPath, {
    d: icons.icons[size][icon]
  })));
};
IconButton.defaultProps = {
  size: icons.IconSize.m
};
